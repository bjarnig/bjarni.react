  ...
  return (
      <div className="container">
        ...
        <div className="content">
          ...
          <article>
            {" "}
            <div className="date">18-09-2026</div>
            <div className="hr">
              <hr />
            </div>
            <h4>World Tour Vol.2 released on Superpang</h4>
            <div className="img-center">
              <a
                href="https://superpang.bandcamp.com/album/superpang-world-tour-vol-2"
                target="_blank"
                rel="noopener noreferrer"
              >
                <OpacityImage imageUrl={superpang_world2} />
              </a>
            </div>
            <p>
              Superpang is pleased to present a series of three compilations
              bringing together friends, musicians who have already worked with
              the label, and future collaborators, all united for a good cause.
            </p>
            <p>
              As often happens with projects like this, the idea grew bigger and
              bigger, thanks above all to the generosity of the artists who
              donated their unreleased work without receiving any compensation,
              making it possible for every single penny generated by the
              compilations to be donated to charity. This feels especially
              important in the world we live in today.
            </p>
            <p>
              As the project develops, you'll be able to follow the donations
              here and in our stories. We want to donate the proceeds to three
              different organizations, one for each volume of the compilation.
            </p>
            <p>All the proceeds for Vol.2 will go to charity.</p>
            <p>
              <a
                href="https://superpang.bandcamp.com/album/superpang-world-tour-vol-2"
                target="_blank"
                rel="noopener noreferrer"
              >
                superpang.bandcamp.com/album/superpang-world-tour-vol-2
              </a>
            </p>
          </article>
