          ...
          <div className="content prose">
            ...
            <div className="bio">
              <div className="row">
                ...
                <p>Bjarni Gunnarsson is a composer and programmer whose practice is centred on generative behaviours in computational processes. His work examines how sound organisation emerges from interactions, exploring concepts such as networks, inference and feedback. He studies how systems can model and influence sound behaviour, focusing on emergence, temporal complexity, and evolving relations between dynamic material.</p>
                <p>Recent projects have explored database-driven recomposition, agent-based simulations, small-world graphs, real-time network growth with interrupt control, latent-space interpolation, and sequential inference for audio-to-structure mapping. Common to these is a way of working from within a running system through observation and intervention of an active algorithm. Processes are attached and detached, contexts reconfigured, and flows interrupted as the music unfolds. The relationship between algorithm and sound is treated as a compositional focus in its own right.</p>
                <p>His work has been presented at ICMC, ICLC, SMC, and xCoAx, and performed at festivals including Tectonics, Rewire, Today's Art, Sonar, and Présences Électroniques. His writings have been published by ECHO – Journal of Music, Thought and Technology (Orpheus Instituut) and The Journal for Artistic Research (JAR). His music appears on labels such as SUPERPANG, SØVN, 3LEAVES, Flag Day Recordings, Tartaruga, and Shipwrec. Solo releases include Safn 2006–2009, Processes & Potentials, Paths, Lueur, Volume & Void, Cendres, Anticlines, UPICS and Fracas.</p>
