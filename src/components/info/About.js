          ...
          <div className="content prose">
            ...
            <div className="bio">
              <div className="row">
                ...
                <p>Recent projects explore database-driven recomposition, agent-based simulations, small-world graphs, real-time network growth, latent-space interpolation, and inference for audio-to-structure mapping. Common to these is a way of working from within a running system through observation and intervention. Processes are attached and detached, contexts reconfigured, and flows interrupted. The relationship between algorithm and sound is treated as a compositional focus in its own right.</p>
