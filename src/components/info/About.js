          ...
          <div className="content">
            ...
            <div className="bio">
              <div className="row">
                ...
                <p>These systems are exploratory rather than fixed, operating in dynamic configurations where feedback, inference, and temporal layering become musical parameters. Structures are not imposed but emerge through accumulation, variation, and the entangled behaviour of multiple components. Sound in this context is a result of process, by both the machine and the composer, as processes unfold and relations take shape across time.</p>
